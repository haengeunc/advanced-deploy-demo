- dashboard: user_report
  title: User report
  layout: newspaper
  preferred_viewer: dashboards-next
  description: ''
  preferred_slug: xibv54JATxIdkemNRF1rTy
  elements:
  - title: User report
    name: User report
    model: haengeun_demo
  ...
  - title: Count of users by country
    name: Count of users by country
    model: haengeun_demo
    explore: users
    type: looker_column
    ...
    width: 8
    height: 6
  - title: Count of users by gender
    name: Count of users by gender
    model: haengeun_demo
    explore: users
    type: looker_pie
    ...
    y_axes: [{label: '', orientation: left, series: [{axisId: users.count, id: users.count,
        ...
        series: [{axisId: users.avg_age, id: users.avg_age, name: Avg Age}], showLabels: true,
